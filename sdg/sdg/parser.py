...
def create_argparser():
    ...
    # 这行代码的作用是获取环境变量'LOCAL_RANK'的值，如果该环境变量不存在，则返回0，应该就是cuda的编号
    ...
    # inference
    parser.add_argument('--model_path', type=str, default='models/lsun_cat.pt')
    ...
    parser.add_argument('--text_instruction_file', type=str, default='ref/cat_guidance.txt')
    parser.add_argument('--clip_path', type=str, default='models/clip_cat.pt')
